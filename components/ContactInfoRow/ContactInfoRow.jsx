...
export const ContactInfoRow = ({ contact, emojies }) => {
    ...
    return (<div className="contact-info-container">
        <div className="contact-data">
            ...
            <input placeholder="Name..." readOnly={!isEdited} value={name} onChange={(e) => handleInputChange(e, 'name')} />
            <input placeholder="Surname..." readOnly={!isEdited} value={surname} onChange={(e) => handleInputChange(e, 'surname')} />
            <input placeholder="Phone..." readOnly={!isEdited} value={phone} onChange={(e) => handleInputChange(e, 'phone')} type="number" />
        </div>
